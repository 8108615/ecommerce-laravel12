<x-admin-layout :breadcrumbs="[
    ...
    <form action="{{ route('admin.covers.update', $cover) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <x-input name="title" value="{{ old('title', $cover->title) }}" class="w-full" placeholder=" Por favor ingrese el Titulo de la Portada"></x-input>
        </div>
        ...
        <div class="mb-4 flex space-x-2">
            ...
            <label>
                <x-input type="radio" name="is_active" value="1" :checked="$cover->is_active == 1"></x-input>
                Activo
            </label>

            <label>
                <x-input type="radio" name="is_active" value="0" :checked="$cover->is_active == 0"></x-input>
                Inactivo
            </label>
