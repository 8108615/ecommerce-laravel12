        ...
        <x-slot name="content">
            ...
            <div class="grid grid-cols-2 gap-6 mb-4">
                <div>
                    ...
                    <x-input wire:model="newOption.name" class="w-full" placeholder="Por Ejemlo: Tamaño, Color "></x-input>
                </div>
                    ...
                    <div class="p-6 rounded-lg border border-gray-200 relative" wire:key="features-{{ $index }}">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                @switch($newOption->type)
                                    @case(1)
                                        ...
                                        <x-input wire:model="newOption.features.{{ $index }}.value" class="w-full" placeholder="Ingrese el Valor de la Opcion"></x-input>
                            ...
                            <div>
                                ...
                                <x-input wire:model="newOption.features.{{ $index }}.description" class="w-full" placeholder="Ingrese una Descripcion"></x-input>
                            </div>
